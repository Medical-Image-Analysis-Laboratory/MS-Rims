...
def get_model_graph(patch_size, *, n_channels = 1, weight_ce=[1., 1.]):
    ...
    phase_concat_2 = tf.concat([pool2, enh1_pool2, enh2_pool2], 4)
    # Layer #3
    conv3 = conv_3d(phase_concat_2, 128, 3, activation='tanh', weights_init='xavier', padding='same', regularizer="L2")
