...
from training import train_fold_ncv_autosplit, get_folded_data, print_all
...
train_fold_ncv_autosplit(NETWORK, folds_data, folds_data_test, contrasts=NETWORK_CONTRASTS,
